...
::: {.cr-section .hide-narrative .mobile-only-overlay layout="overlay-center"}
Track progress. @cr-route-progress-mobile

| {#cr-route-progress-mobile .cr-text .scale-to-fill}
| Current route progress: [0.0 mi]{#cr-distance-driven} driven of [0.0 mi]{#cr-distance-total} planned.
:::
...
",
"  function updateNarrativeDistance(distanceDriven) {
",
"    var drivenEl = document.getElementById('cr-distance-driven');
",
"    var totalEl = document.getElementById('cr-distance-total');
",
"    var drivenMi = formatNumber(distanceDriven * 0.62, 1) + ' mi';
",
"    var totalMi = formatNumber(totalPlannedDistance * 0.62, 1) + ' mi';
",
"    if (drivenEl) drivenEl.textContent = drivenMi;
",
"    if (totalEl) totalEl.textContent = totalMi;
",
"  }
...
"      tracer.openPopup();
",
"      updateNarrativeDistance(gradientState.baseDistanceDriven);
",
"    } else {
",
...
",
"      updateNarrativeDistance(distanceDriven);
",
"      idx++;
",
"    }, stepMs);
