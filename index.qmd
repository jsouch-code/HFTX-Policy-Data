...
m <- leaflet(
  ...
  height = "90vh",
  width  = "68vw",
  options = leafletOptions(zoomDelta = 0.01, dragging = TRUE)
) |>
  ...
  addPolygons(
    ...
    highlightOptions = highlightOptions(weight = 5, opacity = 1, color = "#D24699"),
  ...
  addLegend(pal = pal_pop,  values = texas_map$population,
            title = "Population of women (15–49)", opacity = 1,
            group = "Population") |>
  addLegend(pal = pal_perk, values = texas_map$PWCT_TX_2023_total_PerK,
