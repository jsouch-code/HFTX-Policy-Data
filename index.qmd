...
"  }
",
"  function smoothHeading(unitState, targetDeg) {
",
"    if (unitState.heading === null) { unitState.heading = targetDeg; return unitState.heading; }
",
"    var delta = wrapAngle180(targetDeg - unitState.heading);
",
"    if (Math.abs(delta) < headingMinDelta) return unitState.heading;
",
"    unitState.heading = unitState.heading + (delta * headingSmoothing);
",
"    return unitState.heading;
",
"  }
",
"  function setTracerRotation(unitState, marker, angleDeg) {
",
...
",
"    var shownDeg = smoothHeading(unitState, angleDeg);
",
...
",
"  function drawPartSlow(unitState, pts, gradientState, feature, done) {
",
"    if (!pts || pts.length < 2) { done(); return; }
",
"    if (!unitState.tracer) {
",
"      unitState.tracer = L.marker([pts[0][1], pts[0][0]], { icon: markerIcon }).addTo(map);
",
"      unitState.tracer.bindPopup(buildTracerTooltip(feature, gradientState.baseDistanceDriven), {
",
...
"      });
",
"      if (unitState.showPopup) unitState.tracer.openPopup();
",
"    } else {
",
"      unitState.tracer.setLatLng([pts[0][1], pts[0][0]]);
",
"      unitState.tracer.setPopupContent(buildTracerTooltip(feature, gradientState.baseDistanceDriven));
",
"    }
",
"    unitState.heading = null;
",
"    setTracerRotation(unitState, unitState.tracer, bearingDeg(pts[0], pts[1]));
",
"    var idx = 1;
",
...
",
"      L.polyline([[a[1], a[0]], [b[1], b[0]]], { color: segColor, weight: 5, opacity: 1 }).addTo(unitState.group);
",
"      unitState.tracer.setLatLng([b[1], b[0]]);
",
"      setTracerRotation(unitState, unitState.tracer, bearingDeg(a, b));
",
...
",
"      unitState.tracer.setPopupContent(buildTracerTooltip(feature, distanceDriven));
",
"      idx++;
",
"    }, stepMs);
...
",
"  function drawRouteSlow(unitState, feature, baseDistanceDriven, done) {
",
...
",
"      drawPartSlow(unitState, denseParts[p], gradientState, feature, function(){ p++; nextPart(); });
",
"    }
",
"    nextPart();
...
",
"  function animateAllRoutes(unitState) {
",
"    if (unitState.started) return;
",
"    unitState.started = true;
",
"    var i = 0;
",
...
"      var feature = feats[i];
",
"      drawRouteSlow(unitState, feature, completedDistance, function(){
",
"        var props = (feature && feature.properties) ? feature.properties : {};
",
...
",
"  function findSecondUnitTrigger() {
",
"    var triggers = Array.from(document.querySelectorAll('.narrative-col .trigger'));
",
"    return triggers.find(function(el) {
",
"      var txt = (el.textContent || '').replace(/\\s+/g, ' ').trim();
",
"      return txt.indexOf('By 2026, South Texas Family Planning & Health Corporation (STFPHC) had grown to operate a second mobile unit') !== -1;
",
"    }) || null;
",
"  }
...
",
"  var firstUnit = { group: L.layerGroup().addTo(map), tracer: null, heading: null, showPopup: true, started: false };
",
"  var secondUnit = { group: L.layerGroup().addTo(map), tracer: null, heading: null, showPopup: false, started: false };
",
"  animateAllRoutes(firstUnit);
",
"  var secondTrigger = findSecondUnitTrigger();
",
"  if (secondTrigger) {
",
...
",
"        if (entry.isIntersecting) animateAllRoutes(secondUnit);
",
"      });
",
"    }, { threshold: 0.45 });
",
"    triggerObserver.observe(secondTrigger);
",
"  }
",
"}
