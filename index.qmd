...
m <- leaflet(
  ...
  height = "85vh",
  width  = "68vw",
  options = leafletOptions(zoomDelta = 0.5, zoomSnap = 0, dragging = FALSE, minZoom = 6.2999, scrollWheelZoom = FALSE)
) |>
  ...
  addPolygons(
    ...
    fillOpacity = 1, stroke = TRUE,
    highlightOptions = highlightOptions(weight = 5, opacity = 1, color = "#D24699", bringToFront = TRUE),
    label = ~paste("There were", round(PWCT_TX_2023_total_PerK, 2), "providers per 1,000 women (15–49) in", texas_map$CNTY_NM,"County in 2023."),
    popup = paste(texas_map$CNTY_NM, "County"),
    labelOptions = labelOptions(textsize = "15px", style = list("font-weight"="bold","padding"="6px"))
  ) |>
