...
",
"  var followCenterThrottleMs = 120;
",
"  var followCenterMinPx = 16;
",
"  var lastFollowCenterAt = 0;
",
"
",
...
",
"    if (followVanWhenZoomed && tracer) {
",
"      keepVanCentered(tracer.getLatLng(), true);
",
"    }
",
...
"  }
",
"  function keepVanCentered(latLng, force) {
",
"    if (!followVanWhenZoomed || !latLng) return;
",
"    var now = Date.now();
",
"    if (!force && (now - lastFollowCenterAt) < followCenterThrottleMs) return;
",
"    var vanPt = map.latLngToContainerPoint(latLng);
",
"    var centerPt = map.latLngToContainerPoint(map.getCenter());
",
"    var dx = vanPt.x - centerPt.x;
",
"    var dy = vanPt.y - centerPt.y;
",
"    var dist = Math.sqrt((dx * dx) + (dy * dy));
",
"    if (!force && dist < followCenterMinPx) return;
",
...
",
"        keepVanCentered(L.latLng(b[1], b[0]));
",
"      }
",
