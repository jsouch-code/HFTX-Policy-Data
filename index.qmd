...
<span id="cr-map2-mobile-metrics" style="display:none;">
STFPHC mobile unit has driven <strong><span id="cr-map2-driven-mi">0.0</span> miles</strong> so far, out of <strong><span id="cr-map2-total-mi">0.0</span> total planned miles</strong>.
</span>
...
",
"    var wrap = document.getElementById('cr-map2-mobile-metrics');
",
"    var drivenEl = document.getElementById('cr-map2-driven-mi');
",
"    var totalEl = document.getElementById('cr-map2-total-mi');
",
