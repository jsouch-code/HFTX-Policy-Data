...
",
"  var readoutId = (el.id || 'route-map') + '-distance-readout';
",
"  var readoutEl = document.getElementById(readoutId);
",
"  if (!readoutEl) {
",
"    readoutEl = document.createElement('div');
",
"    readoutEl.id = readoutId;
",
"    readoutEl.style.marginTop = '10px';
",
"    readoutEl.style.fontWeight = '600';
",
"    readoutEl.style.fontSize = '0.95rem';
",
"    el.parentNode.appendChild(readoutEl);
",
"  }
",
"  function updateDistanceReadout(distanceDriven, totalDistance) {
",
"    readoutEl.textContent = 'Total miles driven: ' + distanceDriven.toFixed(1) + ' mi of ' + totalDistance.toFixed(1) + ' mi';
",
"  }
...
"  }, 0);
",
"  updateDistanceReadout(0, totalPlannedDistance);
...
"    }
",
"    updateDistanceReadout(gradientState.baseDistanceDriven, totalPlannedDistance);
",
"    tracerHeading = null;
",
...
",
"      updateDistanceReadout(distanceDriven, totalPlannedDistance);
",
"      idx++;
",
"    }, stepMs);
...
",
"      updateDistanceReadout(completedDistance, totalPlannedDistance);
",
"      i++;
",
"      nextRoute();
