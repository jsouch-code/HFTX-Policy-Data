...
m <- leaflet(
  ...
  addMarkers(
    ...
    clusterOptions = markerClusterOptions(
      iconCreateFunction = JS("function(cluster){ return L.divIcon({ html: '<div title=\"FPP\"><span>' + cluster.getChildCount() + '</span></div>', className: 'marker-cluster marker-cluster-fpp', iconSize: new L.Point(40, 40) }); }")
    ),
    group = "FPP Providers"
  ) |>
  addMarkers(
    ...
    clusterOptions = markerClusterOptions(
      iconCreateFunction = JS("function(cluster){ return L.divIcon({ html: '<div title=\"HTW\"><span>' + cluster.getChildCount() + '</span></div>', className: 'marker-cluster marker-cluster-htw', iconSize: new L.Point(40, 40) }); }")
    ),
    group = "HTW Providers"
  ) |>
