...
[@cr-mytext1]{highlight="cr-t1"} Scroll down.
:::::
...
[@cr-mytext2]{highlight="cr-t5,cr-t6"} Scroll down. 
...
m <- leaflet(
  ...
  height = "85vh",
  width  = "68vw",
  options = leafletOptions(zoomDelta = 0.5, zoomSnap = 0, dragging = FALSE, minZoom = 6.4999, scrollWheelZoom = FALSE)
) |>
